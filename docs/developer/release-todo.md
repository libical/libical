...
* make sure the [github actions CI](https://github.com/libical/libical/actions) is green
* look for any static checking issues (clang-tidy, cppcheck, splint, etc) that may need fixing.
