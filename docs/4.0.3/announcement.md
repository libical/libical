# Announcing Libical 4.0.3

Announcing Libical 4.0.3.

Version 4.0.3 is a patch release.
...
Tarballs and zipballs for v4.0.3 are available from: <https://github.com/libical/libical/releases/tag/v4.0.3>
