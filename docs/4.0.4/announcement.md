# Announcing Libical 4.0.4

Announcing Libical 4.0.4.

Version 4.0.4 is a patch release.
...
Tarballs and zipballs for v4.0.4 are available from: <https://github.com/libical/libical/releases/tag/v4.0.4>
