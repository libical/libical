...
GLIBOPTS="$STRICT -DLIBICAL_DEVMODE=True -DLIBICAL_GLIB=True -DLIBICAL_GOBJECT_INTROSPECTION=True -DUSE_BUILTIN_TZDATA=OFF -DLIBICAL_GLIB_VAPI=ON"
...
NINJA_GCC_BUILD testninjagcc6 "-DSTATIC_ONLY=True -DLIBICAL_GOBJECT_INTROSPECTION=False -DLIBICAL_GLIB_BUILD_DOCS=False"
