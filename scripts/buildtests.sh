...
LSAN_DISABLE="-DLIBICAL_JAVA_BINDINGS=OFF -DICAL_GLIB_VAPI=OFF -DGOBJECT_INTROSPECTION=False -DICAL_GLIB=False -DLIBICAL_BUILD_DOCS=False"
...
MSAN_DISABLE="-DCMAKE_DISABLE_FIND_PACKAGE_ICU=True -DLIBICAL_CXX_BINDINGS=False -DLIBICAL_JAVA_BINDINGS=OFF -DICAL_GLIB_VAPI=OFF -DGOBJECT_INTROSPECTION=False -DICAL_GLIB=False -DLIBICAL_BUILD_DOCS=False"
...
TSAN_DISABLE="-DLIBICAL_JAVA_BINDINGS=OFF -DICAL_GLIB_VAPI=OFF -DGOBJECT_INTROSPECTION=False -DICAL_GLIB=False -DLIBICAL_BUILD_DOCS=False"
