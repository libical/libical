...
MSAN_DISABLE="-DCMAKE_DISABLE_FIND_PACKAGE_ICU=True -DWITH_CXX_BINDINGS=False -DLIBICAL_JAVA_BINDINGS=OFF -DICAL_GLIB_VAPI=OFF -DGOBJECT_INTROSPECTION=False -DICAL_GLIB=False -DICAL_BUILD_DOCS=False"
