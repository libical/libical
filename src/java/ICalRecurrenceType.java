...
public class ICalRecurrenceType
{
	...
	{
		int ICAL_MSEC_RECURRENCE=0;
		int ICAL_SECONDLY_RECURRENCE=1;
		int ICAL_MINUTELY_RECURRENCE=2;
		int ICAL_HOURLY_RECURRENCE=3;
		int ICAL_DAILY_RECURRENCE=4;
		int ICAL_WEEKLY_RECURRENCE=5;
		int ICAL_MONTHLY_RECURRENCE=6;
		int ICAL_YEARLY_RECURRENCE=7;
	        int ICAL_NO_RECURRENCE=8;
	}
