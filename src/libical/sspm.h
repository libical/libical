...
LIBICAL_ICAL_EXPORT char *sspm_decode_quoted_printable(char *dest, const char *src, size_t *size);

LIBICAL_ICAL_EXPORT char *sspm_decode_base64(char *dest, const char *src, size_t *size);
