...
/**
 * @brief Checks if the given @a count is in accordance with the given restriction, @a restr.
...
/**
 * @brief Checks if a given `VCALENDAR` meets all the restrictions imposed by the standard.
