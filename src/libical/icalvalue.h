...
/**
 *  Outdated function to clone a value
 *  This function is deprecated to get more consistency between the all the
 *  icalanything_clone() functions. In reality it is an alias for icalvalue_clone()
 *  @deprecated use icalvalue_clone() instead
 */
LIBICAL_ICAL_EXPORT _deprecated(icalvalue *icalvalue_new_clone(const icalvalue *value));
