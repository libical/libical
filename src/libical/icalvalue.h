...
LIBICAL_ICAL_EXPORT icalparameter_xliccomparetype icalvalue_compare(const icalvalue *a, const icalvalue *b);
...
LIBICAL_ICAL_EXPORT bool icalvalue_encode_ical_string(const char *szText, char *szEncText, int MaxBufferLen);

/** Extract the original character string encoded by the above function **/
LIBICAL_ICAL_EXPORT bool icalvalue_decode_ical_string(const char *szText, char *szDecText, int nMaxBufferLen);
